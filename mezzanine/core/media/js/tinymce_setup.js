...
tinyMCE.init({
    ...
    theme_advanced_buttons1: "bold,italic,underline,|,link,unlink,|,image,|,pasteword,media,charmap,|,code,|,table,cleanup,|,bullist,numlist,blockquote,|,undo,redo,|,formatselect,styleselect",
    theme_advanced_buttons2: "justifyleft,justifycenter,justifyright,justifyfull,|,cut,copy",
